...
## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { clk100_i }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
...
## Buttons
set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS25 } [get_ports { reset_i }]; #IO_L20N_T3_16 Sch=btnc
...
## UART
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { dbg_uart_txd_o }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { dbg_uart_rxd_i }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
...
## FMC
# ftdi_clk
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS25 } [get_ports { ftdi_clk }]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p
create_clock -add -name ftdi_clk_pin -period 10.00 -waveform {0 5} [get_ports ftdi_clk]

# ftdi_rst
set_property -dict { PACKAGE_PIN K22   IOSTANDARD LVCMOS25 } [get_ports { ftdi_rst }]; #IO_L9N_T1_DQS_AD3N_15 Sch=fmc_la_n[10]

# ftdi_rxf_n
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_rxf_n }]; #IO_L20P_T3_A20_15 Sch=fmc_la_p[07]

# ftdi_txe_n
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_txe_n }]; #IO_L20N_T3_A19_15 Sch=fmc_la_n[07]

# ftdi_rd_n
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS25 } [get_ports { ftdi_rd_n }]; #IO_L13N_T2_MRCC_15 Sch=fmc_la00_cc_n

# ftdi_oe_n
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS25 } [get_ports { ftdi_oe_n }]; #IO_L13P_T2_MRCC_15 Sch=fmc_la00_cc_p

# ftdi_wr_n
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS25 } [get_ports { ftdi_wr_n }]; #IO_L24P_T3_RS1_15 Sch=fmc_la_p[08]

# ftdi_siwua
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_siwua }]; #IO_L24N_T3_RS0_15 Sch=fmc_la_n[08]

# ftdi_be[3:0]
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS25 } [get_ports { ftdi_be[3] }]; #IO_L8P_T1_AD10P_15 Sch=fmc_la_p[09]
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS25 } [get_ports { ftdi_be[2] }]; #IO_L8N_T1_AD10N_15 Sch=fmc_la_n[09]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_be[1] }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_la_p[15]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_be[0] }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_la_n[15]

# ftdi_data[31:0]

set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[31] }]; #IO_L11P_T1_SRCC_16 Sch=fmc_la17_cc_p
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[30] }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la17_cc_n
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[29] }]; #IO_L18P_T2_16 Sch=fmc_la_p[20]
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[28] }]; #IO_L18N_T2_16 Sch=fmc_la_n[20]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[27] }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[26] }]; #IO_L17N_T2_16 Sch=fmc_la_n[19]
set_property -dict { PACKAGE_PIN B21   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[25] }]; #IO_L21P_T3_DQS_16 Sch=fmc_la_p[23]
set_property -dict { PACKAGE_PIN A21   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[24] }]; #IO_L21N_T3_DQS_16 Sch=fmc_la_n[23]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[23] }]; #IO_L23P_T3_16 Sch=fmc_la_p[22]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[22] }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[21] }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[20] }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[19] }]; #IO_L15P_T2_DQS_16 Sch=fmc_la_p[26]
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[18] }]; #IO_L16P_T2_16 Sch=fmc_la_p[27]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[17] }]; #IO_L15N_T2_DQS_16 Sch=fmc_la_n[26]
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[16] }]; #IO_L16N_T2_16 Sch=fmc_la_n[27]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[15] }]; #IO_L2P_T0_16 Sch=fmc_la_p[25]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[14] }]; #IO_L7P_T1_16 Sch=fmc_la_p[24]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[13] }]; #IO_L2N_T0_16 Sch=fmc_la_n[25]
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[12] }]; #IO_L7N_T1_16 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[11] }]; #IO_L3P_T0_DQS_16 Sch=fmc_la_p[29]
set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[10] }]; #IO_L8P_T1_16 Sch=fmc_la_p[28]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[9] }]; #IO_L3N_T0_DQS_16 Sch=fmc_la_n[29]
set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[8] }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[7] }]; #IO_L4P_T0_16 Sch=fmc_la_p[31]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[6] }]; #IO_L10P_T1_16 Sch=fmc_la_p[30]
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[5] }]; #IO_L4N_T0_16 Sch=fmc_la_n[31]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[4] }]; #IO_L10N_T1_16 Sch=fmc_la_n[30]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[3] }]; #IO_L1P_T0_16 Sch=fmc_la_p[33]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[2] }]; #IO_L9P_T1_DQS_16 Sch=fmc_la_p[32]
set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[1] }]; #IO_L1N_T0_16 Sch=fmc_la_n[33]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS25 } [get_ports { ftdi_data[0] }]; #IO_L9N_T1_DQS_16 Sch=fmc_la_n[32]
...
#set_property -dict { PACKAGE_PIN J20   IOSTANDARD LVCMOS25 } [get_ports { fmc_la01_cc_p }]; #IO_L11P_T1_SRCC_15 Sch=fmc_la01_cc_p
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[02] }]; #IO_L16N_T2_A27_15 Sch=fmc_la_n[02]
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[02] }]; #IO_L16P_T2_A28_15 Sch=fmc_la_p[02]
#set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[03] }]; #IO_L17N_T2_A25_15 Sch=fmc_la_n[03]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[03] }]; #IO_L17P_T2_A26_15 Sch=fmc_la_p[03]
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[04] }]; #IO_L18N_T2_A23_15 Sch=fmc_la_n[04]
#set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[04] }]; #IO_L18P_T2_A24_15 Sch=fmc_la_p[04]
#set_property -dict { PACKAGE_PIN L21   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[05] }]; #IO_L10N_T1_AD11N_15 Sch=fmc_la_n[05]
#set_property -dict { PACKAGE_PIN M21   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[05] }]; #IO_L10P_T1_AD11P_15 Sch=fmc_la_p[05]
#set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[06] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=fmc_la_n[06]
#set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[06] }]; #IO_L15P_T2_DQS_15 Sch=fmc_la_p[06]
#set_property -dict { PACKAGE_PIN K21   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[10] }]; #IO_L9P_T1_DQS_AD3P_15 Sch=fmc_la_p[10]
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[11] }]; #IO_L22N_T3_A16_15 Sch=fmc_la_n[11]
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[11] }]; #IO_L22P_T3_A17_15 Sch=fmc_la_p[11]
...
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[13] }]; #IO_L21N_T3_DQS_A18_15 Sch=fmc_la_n[13]
#set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[13] }]; #IO_L21P_T3_DQS_15 Sch=fmc_la_p[13]
#set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_n[14] }]; #IO_L7N_T1_AD2N_15 Sch=fmc_la_n[14]
#set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS25 } [get_ports { fmc_la_p[14] }]; #IO_L7P_T1_AD2P_15 Sch=fmc_la_p[14]
...
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS25 } [get_ports { fmc_la18_cc_n }]; #IO_L12N_T1_MRCC_16 Sch=fmc_la18_cc_n
